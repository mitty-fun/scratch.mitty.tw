...
/* harmony default export */ __webpack_exports__["default"] = (function (appTarget) {
  ...
  var WrappedGui = Object(redux__WEBPACK_IMPORTED_MODULE_2__["compose"])(_lib_app_state_hoc_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], _lib_hash_parser_hoc_jsx__WEBPACK_IMPORTED_MODULE_5__["default"], OrangeAppleHOC)(_containers_gui_jsx__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
var OrangeAppleHOC = function OrangeAppleHOC(WrappedComponent) {
  var OrangeAppleComponent = /*#__PURE__*/function (_React$Component) {
    _inherits(OrangeAppleComponent, _React$Component);
    var _super = _createSuper(OrangeAppleComponent);
    function OrangeAppleComponent(props) {
      var _this;
      _classCallCheck(this, OrangeAppleComponent);
      _this = _super.call(this, props);
      var data = {};
      Object.keys(localStorage).forEach(function (key) {
        data[key] = localStorage.getItem(key);
      });
      _this.props.vm.postIOData('DB', data);
      _this.props.vm.on('DB_SET', function (field, value) {
        localStorage.setItem(field, value);
      });
      _this.props.vm.on('DB_CLEAR', function () {
        localStorage.clear();
      });
      _this.props.vm.on('PASS', function () {
        alert('過關！');
      });
      return _this;
    }
    _createClass(OrangeAppleComponent, [{
      key: "render",
      value: function render() {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WrappedComponent, this.props);
      }
    }]);
    return OrangeAppleComponent;
  ...
  return Object(react_redux__WEBPACK_IMPORTED_MODULE_7__["connect"])(mapStateToProps)(OrangeAppleComponent);
};
